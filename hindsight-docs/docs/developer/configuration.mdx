...
import configurationPy from '!!raw-loader!@site/examples/api/configuration.py';
import configurationSh from '!!raw-loader!@site/examples/api/configuration.sh';
...
<CodeSnippet code={configurationSh} section="plain-retrieval-bank" language="bash" />
...
<CodeSnippet code={configurationPy} section="retain-strategy" language="python" />
...
<CodeSnippet code={configurationSh} section="mcp-tools-per-bank" language="bash" />
...
<CodeSnippet code={configurationSh} section="bank-config-examples" language="bash" />
